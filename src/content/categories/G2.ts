          ...
          examples: [
            {
              ...
              bn: "সমস্যাটা কী ছিল?",
              pronunciation_bn: "হোয়াট ওয়াজ দা প্রবলেম?",
            ...
            },
            {
              ...
              bn: "স্কোর কত ছিল?",
              pronunciation_bn: "হোয়াট ওয়াজ দা স্কোর?",
              slotValues: { THING: "the score" },
              topicArea: "daily_life",
            },
            {
      ...
      variations: [
        ...
        },
        {
          ...
          examples: [
            ...
            {
              en: "When can I come?",
              bn: "আমি কখন আসতে পারি?",
              pronunciation_bn: "হোয়েন ক্যান আই কাম?",
            ...
            },
            {
              ...
              bn: "আমি কখন ফোন করবো?",
              pronunciation_bn: "হোয়েন শুড আই কল?",
    ...
    // ==================== G2.4 — কেন (Why) ====================
    {
      ...
      examples: [
        ...
        },
        {
          ...
          slotValues: { REASON_CLAUSE: "you work at night" },
          topicArea: "work",
          stage: 2,
      ...
      examples: [
        {
          ...
          topicArea: "food",
          stage: 1,
          miniStory: { situation_bn: "তুমি ঢাকায় নতুন এসেছো। অফিসে কীভাবে যাবে জানো না।", icon: "🚌" },
        },
        {
          ...
          topicArea: "work",
          stage: 1,
          miniStory: { situation_bn: "তুমি চা বানাতে চাও কিন্তু জানো না কীভাবে।", icon: "🍵" },
        },
        {
        ...
        },
        {
          ...
          topicArea: "health",
          stage: 2,
          miniStory: { situation_bn: "তোমার মোবাইল খারাপ হয়ে গেছে। মেকানিককে জিজ্ঞেস করছো কীভাবে ঠিক করবে।", icon: "📱" },
        },
        {
      ...
      variations: [
        ...
        },
        {
          ...
          examples: [
            ...
            {
              en: "Could you tell me how to use this?",
              bn: "আপনি কি বলবেন কীভাবে এটা ব্যবহার করতে হয়?",
              pronunciation_bn: "কুড ইউ টেল মি হাও টু ইউজ দিস?",
              slotValues: { ACTION: "use this" },
              topicArea: "daily_life",
            },
            {
          ...
          examples: [
            {
              ...
              bn: "কালকে কেমন হয়?",
              pronunciation_bn: "হাও অ্যাবাউট টুমরো?",
              slotValues: { ACTION: "tomorrow" },
              topicArea: "daily_life",
            },
            {
              en: "How about tea?",
      ...
      variations: [
        ...
        },
        {
          ...
          examples: [
            ...
            {
              en: "Who is knocking?",
              bn: "কে দরজায় নক করছে?",
              pronunciation_bn: "হু ইজ নকিং?",
              slotValues: { ACTION: "knocking" },
              topicArea: "daily_life",
            },
          ],
        },
    ...
    // ==================== G2.7 — কার (Whose) ====================
    {
      ...
      examples: [
        ...
        },
        {
          ...
          stage: 3,
          miniStory: {
            situation_bn: "অফিসে একটা ছাতা রেখে গেছে কেউ।",
            icon: "☂️",
          },
        },
      ],
      ...
      variations: [
        {
          ...
          examples: [
            ...
            {
              en: "Whose house was this before?",
              bn: "আগে এটা কার বাড়ি ছিল?",
              pronunciation_bn: "হুজ হাউস ওয়াজ দিস বিফোর?",
              slotValues: { THING: "house" },
              topicArea: "daily_life",
            },
            {
    ...
    // ==================== G2.8 — কোনটা (Which) ====================
    {
      ...
      examples: [
        ...
        },
        {
          ...
          miniStory: {
            situation_bn:
              "ডাক্তার তোমাকে দুটো ওষুধ দেখাচ্ছে। তুমি জানতে চাও কোনটা খাবে।",
            icon: "💊",
          },
        },
      ],
      ...
      variations: [
        ...
        },
        {
          ...
          examples: [
            ...
            {
              en: "Which one should I take?",
              bn: "কোনটা আমার নেওয়া উচিত?",
              pronunciation_bn: "হুইচ ওয়ান শুড আই টেক?",
        ...
        },
        {
          ...
          examples: [
            ...
            {
              en: "Could you tell me which floor?",
              bn: "আপনি কি বলবেন কোন তলায়?",
              pronunciation_bn: "কুড ইউ টেল মি হুইচ ফ্লোর?",
              slotValues: { THING: "floor" },
              topicArea: "daily_life",
            },
            {
    ...
    // ==================== G2.9 — কত (How + Quantity) ====================
    {
      ...
      examples: [
        ...
        },
        {
          ...
          miniStory: {
            situation_bn:
              "তুমি রিকশায় উঠতে চাও। ভাড়া কত জানো না।",
            icon: "🛺",
          },
        },
        {
        ...
        },
        {
          ...
          miniStory: {
            situation_bn:
              "তোমার বন্ধু জানতে চায় তোমার কয়টা ভাই-বোন আছে।",
            icon: "👨‍👩‍👧‍👦",
          },
        },
      ],
      ...
      variations: [
        ...
        },
        {
          ...
          examples: [
            {
              en: "How about tomorrow?",
              bn: "আগামীকাল কেমন হয়?",
              pronunciation_bn: "হাও অ্যাবাউট টুমরো?",
              slotValues: { SUGGESTION: "tomorrow" },
              topicArea: "daily_life",
            },
            {
